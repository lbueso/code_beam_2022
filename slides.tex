...
\label{sec:orgdb31402}

\begin{frame}[label={sec:org192ec9d}]{The problem}
\begin{columns}
...
\begin{frame}[label={sec:orgc178d0a},fragile]{Introduction to PBT}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org1aef7cd},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:orgcf16638},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
...
\begin{frame}[label={sec:org94f0c7f},fragile]{PBT state machines}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orgf9883d7},fragile]{Makina}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org5e7e1c2},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
