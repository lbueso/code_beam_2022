...
\label{sec:org6758649}

\begin{frame}[label={sec:org49808be}]{The problem}
\begin{columns}
...
\label{sec:org72efc5b}

\begin{frame}[label={sec:org7387bfd},fragile]{Introduction to PBT}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org083ee92},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:org7bdadb1},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
...
\begin{frame}[label={sec:org0acc41e},fragile]{PBT state machines}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\label{sec:org2002e40}

\begin{frame}[label={sec:orgd3da76d},fragile]{Makina}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org2e59aa4},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\label{sec:org9fec2d3}

\begin{frame}[label={sec:orgf45cff2},fragile]{Mining blocks}
 \begin{columns}
\begin{column}{0.48\columnwidth}
The API:
...
\begin{frame}[label={sec:org88e1b52},fragile]{Consulting callback docs}
...
\begin{frame}[label={sec:org957f46e},fragile]{Adding type information}
 \begin{columns}
...
\begin{frame}[label={sec:org5071df2},fragile]{Adding documentation}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Blocks do
  use Makina, implemented_by: Etherex
...
\begin{frame}[label={sec:org8ca63bd},fragile]{Consulting module docs}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
iex> h Blocks
...
\begin{frame}[label={sec:org00953ab},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
...
\begin{frame}[label={sec:org8eeb2bf},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.48\columnwidth}
The error message:
...
\begin{frame}[label={sec:orgbf3e194},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
Starting Quviq QuickCheck version 1.45.1
...
\label{sec:org08c13c9}

\begin{frame}[label={sec:orgacb3159},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org84e98a2},fragile]{Generating transactions}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
...
\begin{frame}[label={sec:org36d43d2},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
Starting Quviq QuickCheck version 1.45.1
...
\begin{frame}[label={sec:org70d8fd4},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
[
...
\begin{frame}[label={sec:orgdb847ca},fragile]{Fixing the transactions model}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
  use Makina, implemented_by: Etherex, extends: [Accounts, Blocks]
...
\begin{frame}[label={sec:orgf19adbd},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org6a22205},fragile]{Running the tests}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
Commands:
...
%{
  balances: %{
    "0x90f8bf6a479f320ead074411a4b0e7944ea8c9c1" => 1000000000000000000000000000000,
    ...
  },
  ...
}
