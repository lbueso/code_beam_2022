...
\begin{frame}[label={sec:org9706960},fragile]{Makina: The Language}
 \begin{columns}
\begin{column}{0.38\columnwidth}
...
\begin{frame}[label={sec:org2a0c723},fragile]{Ethereum Blockchain}
 Why Ethereum?
\begin{itemize}
...
\label{sec:org82b2572}
\begin{frame}[label={sec:org1ed64e6},fragile]{Mining blocks}
 \begin{columns}
...
\begin{frame}[label={sec:org33bf8e4},fragile]{Mining blocks}
 \begin{columns}
\begin{column}{0.52\columnwidth}
The API:
...
\begin{frame}[label={sec:orgb813882},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<+->
...
\begin{frame}[label={sec:org46c49bb},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:orgd18bb0f},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org374ef49},fragile]{Adding type information}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<3->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:orgd948e23},fragile]{Adding documentation}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<3->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:org990dbb1},fragile]{Adding documentation}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<1->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:org28dde09},fragile]{Adding documentation}
 \begin{columns}
\begin{column}{0.52\columnwidth}
\onslide<1->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\label{sec:org699e322}
\begin{frame}[label={sec:orgaa5738c},fragile]{Account access}
 \begin{columns}
...
\begin{frame}[label={sec:org971d968},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.28\columnwidth}
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:org24dba54},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.28\columnwidth}
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:org61dab89},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.28\columnwidth}
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\label{sec:org53cb816}
\begin{frame}[label={sec:orgd394681},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org5955902},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.44\columnwidth}
\onslide<+->
...
\begin{frame}[label={sec:org377156b},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.44\columnwidth}
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:orge338ffa},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.44\columnwidth}
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org9ce6a9b},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.44\columnwidth}
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\begin{frame}[label={sec:org764152b},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.44\columnwidth}
...
\begin{frame}[label={sec:org3baf247},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.44\columnwidth}
\onslide <+->
\onslide <+->
...
\begin{frame}[label={sec:org35c2a4d},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.38\columnwidth}
...
\begin{frame}[label={sec:org6d7d698},fragile]{Running the test}
 \begin{columns}
\begin{column}{0.38\columnwidth}
\onslide <+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
...
\end{frame}
\section{Conclusions}
\label{sec:org26a8c2d}
\begin{frame}[label={sec:org6a237e0},fragile]{Results}
 \onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org5ebcba7}]{Links}
\begin{columns}
