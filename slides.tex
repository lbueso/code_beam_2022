...
\label{sec:orgff941b4}
\begin{frame}[label={sec:org86d1a9d}]{The problem}
\begin{columns}
...
\begin{frame}[label={sec:org923db94},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:orgf65b94b},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:orgdccceda},fragile]{PBT state machines}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org257f21c},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org1d0cdc4},fragile]{Auto generated documentation}
 \onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:orgc48a17d},fragile]{Auto generated documentation}
 When a model is compiled automatically generates documentation.
\lstset{language=markdown,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
iex> h Blocks
...
\begin{frame}[label={sec:orgbd3065c},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:orgc045987},fragile]{Fixing the model}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org9944d10},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\label{sec:orgf3d4db9}
\begin{frame}[label={sec:org100d503},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:orgff41bac},fragile]{Generating transactions}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org895bbe3},fragile]{Running the test}
 \onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org1e03056},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org88dd8ed},fragile]{Fixing the transactions model}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org08a6de3},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org637e603},fragile]{Running the tests}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org0d1c3a6},fragile]{Fixing the transactions model}
 \begin{columns}
\begin{column}{0.38\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org757fd16},fragile]{Fixing the transactions model}
 \onslide<+->
\onslide<+->
