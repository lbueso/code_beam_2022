...
\label{sec:org105107a}
\begin{frame}[label={sec:org08ef247}]{The problem}
\begin{columns}
...
\begin{frame}[label={sec:orge1d3435},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:org56ad14d},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
...
\begin{frame}[label={sec:org004c5f3},fragile]{PBT state machines}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orgac7193f},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org82a69c7},fragile]{Consulting callback docs}
...
\begin{frame}[label={sec:org1a9de35},fragile]{Adding type information}
 \begin{columns}
...
\begin{frame}[label={sec:orgf5a984c},fragile]{Adding documentation}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Blocks do
  use Makina, implemented_by: Etherex
...
\begin{frame}[label={sec:org527d4d6},fragile]{Consulting module docs}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
iex> h Blocks
...
\begin{frame}[label={sec:org127c2d8},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
$ mix test
...
\begin{frame}[label={sec:orgc019c23},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.48\columnwidth}
The error message:
...
\begin{frame}[label={sec:orga73829b},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
$ mix test
Starting Quviq QuickCheck version 1.45.1
...
\label{sec:orgd8965e7}
\begin{frame}[label={sec:orga57eed2},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orgbb81241},fragile]{Generating transactions}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
...
\begin{frame}[label={sec:org3401d62},fragile]{Running the test}
...
\begin{frame}[label={sec:org108f2b8},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
[
...
\begin{frame}[label={sec:orgbc97d8f},fragile]{Fixing the transactions model}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
  use Makina, implemented_by: Etherex, extends: [Accounts, Blocks]
...
\begin{frame}[label={sec:orgf753671},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org8a8cd6f},fragile]{Running the tests}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
Commands:
