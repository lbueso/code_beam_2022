...
\label{sec:org5484b55}

\begin{frame}[label={sec:org8b07f48}]{The problem}
\begin{columns}
...
\label{sec:org3a42349}

\begin{frame}[label={sec:org252bde3},fragile]{Introduction to PBT}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:org1989a4e},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:org58c3ae1},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
...
\begin{frame}[label={sec:orgec1a085},fragile]{PBT state machines}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\label{sec:orgc19df83}

\begin{frame}[label={sec:org3a6319d},fragile]{Makina}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orga4cf89c},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\label{sec:org145f4e9}

\begin{frame}[label={sec:org52bfa89},fragile]{Mining blocks}
 \begin{columns}
\begin{column}{0.48\columnwidth}
The API:
...
\begin{frame}[label={sec:org4819404},fragile]{Consulting callback docs}
...
\begin{frame}[label={sec:orgc21c283},fragile]{Adding type information}
 \begin{columns}
...
\begin{frame}[label={sec:orgc9c38c4},fragile]{Adding documentation}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Blocks do
  use Makina, implemented_by: Etherex
...
\begin{frame}[label={sec:orgf481203},fragile]{Consulting module docs}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
iex> h Blocks
...
\begin{frame}[label={sec:org5511b72},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
...
\begin{frame}[label={sec:org7b10468},fragile]{Fixing the model}
 \begin{columns}
\begin{column}{0.48\columnwidth}
The error message:
...
\begin{frame}[label={sec:orga7c7c03},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
Starting Quviq QuickCheck version 1.45.1
...
\label{sec:orgb2c1cf3}

\begin{frame}[label={sec:org7a999c2},fragile]{Generating transactions}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orgb7818dd},fragile]{Generating transactions}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
...
\begin{frame}[label={sec:org8c8056c},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
$ mix test
Starting Quviq QuickCheck version 1.45.1
...
\begin{frame}[label={sec:orgd927c65},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
[
...
\begin{frame}[label={sec:org2e106f7},fragile]{Fixing the transactions model}
 \lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
defmodule Transactions do
  use Makina, implemented_by: Etherex, extends: [Accounts, Blocks]
...
\begin{frame}[label={sec:org0e16033},fragile]{Running the test}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:orgaec69c1},fragile]{Running the tests}
 \lstset{language=shell,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
Commands:
