...
\begin{frame}[label={sec:orgfb7eefa},fragile]{Testing \emph{stateful} programs}
 \begin{columns}
...
\begin{frame}[label={sec:org8df7cbe},fragile]{PBT of \emph{stateful} programs}
 \begin{columns}
\begin{column}{0.58\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org01fadf6},fragile]{Ethereum Blockchain}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org9dce557},fragile]{Auto generated documentation}
 \onslide<+->
\onslide<+->
...
\end{lstlisting}
\end{frame}
\begin{frame}[label={sec:orgc0f81e4},fragile]{Auto generated documentation}
 When a model is compiled automatically generates documentation.
\lstset{language=markdown,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
iex> h Blocks
...
\begin{frame}[label={sec:org9e7fba1},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org7e1f680},fragile]{Fixing the model}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org775576a},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:orgf1dd1ab},fragile]{Generating transactions}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org544ffc5},fragile]{Running the test}
 \onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:orgce7d7b1},fragile]{Running the test}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:orge2cd960},fragile]{Fixing the transactions model}
 \onslide<+->
\onslide<+->
\lstset{language=elixir,label= ,caption= ,captionpos=b,numbers=none,style=display}
\begin{lstlisting}
...
\begin{frame}[label={sec:org35b60ab},fragile]{Running the test}
 \onslide<+->
\onslide<+->
\lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org25dd771},fragile]{Running the tests}
 \lstset{language=bash,label= ,caption= ,captionpos=b,numbers=none,style=shell}
\begin{lstlisting}
...
\begin{frame}[label={sec:org4d01eee},fragile]{Fixing the transactions model}
 \begin{columns}
\begin{column}{0.38\columnwidth}
\onslide<+->
\onslide<+->
...
\begin{frame}[label={sec:org3c62da0},fragile]{Fixing the transactions model}
 \onslide<+->
\onslide<+->
